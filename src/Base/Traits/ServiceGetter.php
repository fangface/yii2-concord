...
trait ServiceGetter
{
     ...
     * @param Component|array|null $component the component to be registered with the module.
     */
    public function setService($id, $component)
    {
     ...
     * @return mixed
     */
    public function getServices($loadedOnly = false)
    {
